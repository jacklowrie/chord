...
def run_mininet():
    ...
    h1.cmd(f"python tests/chk_fix_finger/anchor.py 10.0.0.1 {port} > /tmp/h1_fix_finger.log 2>&1 &")
    h2.cmd(f"python tests/chk_fix_finger/joiner.py 10.0.0.2 {port} 10.0.0.1 > /tmp/h2_fix_finger.log 2>&1 &")
